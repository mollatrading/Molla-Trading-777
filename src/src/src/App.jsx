...
export default function App() {
  ...
  const openWhatsAppWith = (text) => {
    const phone = "27842685484"; // international format (without +)
    ...
    <div className="min-h-screen bg-amber-50 text-gray-900 antialiased">
      ...
      <section id="home" className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <p className="mt-4 text-gray-700">Quality women's & men's clothing — wholesale and retail. Fast delivery across Johannesburg.</p>
      ...
      <section id="products" className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Wholesale R45 / Retail R60 for many basics — contact for bulk orders.</p>
          </div>
          ...
          {filtered.map((p) => (
            <div key={p.id} className="bg-white rounded-lg shadow p-3 flex flex-col">
              <div className="h-36 bg-gray-50 rounded overflow-hidden flex items-center justify-center">
                <img src={p.img} alt={p.title} onError={(e)=> e.currentTarget.src="/assets/product-placeholder.svg"} className="object-contain h-full w-full" />
              </div>
      ...
      <section id="about" className="max-w-6xl mx-auto px-4 py-8 bg-white/60">
        ...
        <p className="mt-3 text-gray-700">We supply affordable and stylish clothing for men and women. Wholesale orders welcomed — contact us via WhatsApp for bulk pricing and fast replies.</p>
      </section>
      ...
      {selected && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow p-4 max-w-md w-full">
            ...
            <div className="mt-3">
              <img src={selected.img} alt={selected.title} className="w-full h-56 object-contain" onError={(e)=> e.currentTarget.src="/assets/product-placeholder.svg"} />
